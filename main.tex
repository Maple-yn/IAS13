...
\begin{abstract}
	...
	releasing the coupling provided by the branching tendon while the
	...
	that equipes two tendons including the non-elastic branching tendon.
	% 以上をふまえ，2関節2腱のロボットフィンガを開発し，その制御を行った．
	In addition, we analyse the condition, where the branching tendon gets
